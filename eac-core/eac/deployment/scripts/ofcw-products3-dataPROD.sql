...
set @erightsFREE     = 7501;

set @erightsBRM      = 12002;
set @erightsEME      = 12003;
set @erightsLecPOE2E = 12004;
set @erightsLecBRM   = 12005;
set @erightsLecEME   = 12006;

set @homePage       ='http://cw.oxfordfajar.com.my/index.aspx';
set @landingBRM     ='http://cw.oxfordfajar.com.my/businessresearchmethods';
set @landingLecBRM  ='http://cw.oxfordfajar.com.my/businessresearchmethods';
set @landingEME     ='http://cw.oxfordfajar.com.my/me';
set @landingLecEME  ='http://cw.oxfordfajar.com.my/me';
set @landingLecPOE2E='http://cw.oxfordfajar.com.my/principlesofeconomics2e';
