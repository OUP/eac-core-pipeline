...
set @erightsFREE     = 4301;

set @erightsBRM      = 30002;
set @erightsEME      = 30003;
set @erightsLecPOE2E = 30004;
set @erightsLecBRM   = 30005;
set @erightsLecEME   = 30006;

set @homePage       ='http://uatcw.oxfordfajar.asia/index.aspx';
set @landingBRM     ='http://uatcw.oxfordfajar.asia/businessresearchmethods';
set @landingLecBRM  ='http://uatcw.oxfordfajar.asia/businessresearchmethods';
set @landingEME     ='http://uatcw.oxfordfajar.asia/me';
set @landingLecEME  ='http://uatcw.oxfordfajar.asia/me';
set @landingLecPOE2E='http://uatcw.oxfordfajar.asia/principlesofeconomics2e';
