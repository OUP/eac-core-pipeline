...
public class LoggedInCustomerInterceptorMockTest extends AbstractMockTest {
    ...
    private LoggedInCustomerInterceptor sut;
    ...
    public void setup() {
        ...
        sut = new LoggedInCustomerInterceptor(customerService);
        response = EasyMock.createMock(HttpServletResponse.class);
        setMocks(customerService, response);
    ...
    public void testHappyPath2() throws Exception {
        ...
        MockHttpSession session = new MockHttpSession();
        request.setSession(session);
        Cookie cookie = new Cookie("EAC", "123456");
        request.setCookies(cookie);

        EasyMock.expect(customerService.getCustomerFromSession("123456")).andReturn(customer);
        replayMocks();
        boolean canProceed = sut.preHandle(request, response, handler);
        Assert.assertTrue(canProceed);
    ...
    @Test
    public void testUnHappyPath1() throws Exception {
    ...
    @Test
    public void testUnHappyPath2() throws Exception {
        ...
        EasyMock.expect(customerService.getCustomerFromSession("123456")).andReturn(null);
    ...
    @Test
    public void testUnHappyPath3() throws Exception {
        ...
        EasyMock.expect(customerService.getCustomerFromSession("123456")).andThrow(new CustomerNotFoundServiceLayerException());
