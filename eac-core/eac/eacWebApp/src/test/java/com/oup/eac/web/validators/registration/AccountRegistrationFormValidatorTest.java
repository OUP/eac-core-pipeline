...
public class AccountRegistrationFormValidatorTest /* extends AbstractValidatorTest */ {
	/*
	 * 
	 * private AccountRegistrationFormValidator validator; private CustomerService
	 ...
	 * AccountRegistrationFormValidator(customerService, usernameValidator); }
	 * 
	 * @Test public void testValidateNoValues() throws Exception {
	 ...
	 * "title.familyname" }), EasyMock.eq("Surname is required."));
	 * errors.rejectValue(EasyMock.eq("email"), EasyMock.eq("error.not-specified"),
	 * eqLabels(new Object[] { "title.email" }),
	 ...
	 * EasyMock.eq("error.not-specified"), eqLabels(new Object[] { "title.password"
	 * }), EasyMock.eq("Password is required."));
	 * errors.rejectValue(EasyMock.eq("confirmPassword"),
	 * EasyMock.eq("error.not-specified"), eqLabels(new Object[] {
	 * "title.confirmpassword" }), EasyMock.eq("Confirm Password is required."));
	 * replayMocks();
	 * 
	 ...
	 * 
	 * errors.rejectValue(EasyMock.eq("username"),
	 * EasyMock.eq("error.username.taken"), eqLabels(new Object[] {
	 * EACSettings.getProperty(EACSettings.EAC_LOGIN_URL) }),
	 ...
	 * RuntimeException ex ) { Assert.fail("unexpected exception"); }
	 * 
	 * verifyMocks();
	 * 
	 * }
	 ...
	 * null); errors.rejectValue(EasyMock.eq("passwordcheck"),
	 * EasyMock.eq("error.not-specified"), eqLabels(new Object[] { "title.password"
	 * }), EasyMock.eq("Password is required."));
	 * errors.rejectValue(EasyMock.eq("confirmPassword"),
	 * EasyMock.eq("error.not-specified"), eqLabels(new Object[] {
	 ...
	 * andReturn(null); errors.rejectValue(EasyMock.eq("passwordcheck"),
	 * EasyMock.eq(PasswordUtils.INVALID_PASSWORD_MSG_CODE), eqLabels(new Object[] {
	 * "title.password" }), EasyMock.eq("Password is too easy."));
