...
public class AmazonCloudSearchQuery {
	...
	private static final Logger logger = Logger.getLogger(AmazonCloudSearchQuery.class);
	...
	public String build() throws UnsupportedEncodingException {
		...
		if(logger.isDebugEnabled()){ logger.debug("Inside build method"); }
		StringBuilder builder = new StringBuilder();
		...
		if(logger.isDebugEnabled()){ logger.debug("Exiting build method with query" +builder.toString()); }
