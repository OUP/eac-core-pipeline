...
public class ExternalSystemBeanValidatorTest extends AbstractMockTest {
    ...
    private ExternalSystemBeanValidator validator;
    private ExternalIdService externalIdService;
    private Errors mockErrors;
    
	public ExternalSystemBeanValidatorTest() throws NamingException {
        super();
    }
	
    @Before
    public void setup(){
        externalIdService = createAndAddMock(ExternalIdService.class);
        mockErrors = createAndAddMock(Errors.class);
        validator = new ExternalSystemBeanValidator(externalIdService);
    }

	@Test	
	public void shouldRejectWhenSystemIdEmpty() {
		ExternalSystem externalSystem = new ExternalSystem();
		externalSystem.setId("12345");
		externalSystem.setName("");
		externalSystem.setDescription("description");
		ExternalSystemBean externalSystemBean = new ExternalSystemBean(Arrays.asList(externalSystem));
		externalSystemBean.setSelectedExternalSystemGuid("12345");
		
		try {
			EasyMock.expect(externalIdService.getAllExternalSystemsOrderedByName()).andReturn(Arrays.asList(externalSystem));
	...
	@Test	
	public void shouldRejectWhenSystemTypeIdEmpty() {
		ExternalSystem externalSystem = new ExternalSystem();
		externalSystem.setId("12345");
		...
		externalSystem.setExternalSystemIdTypes(new HashSet<ExternalSystemIdType>(Arrays.asList(externalSystemIdType)));
		ExternalSystemBean externalSystemBean = new ExternalSystemBean(Arrays.asList(externalSystem));
		externalSystemBean.setSelectedExternalSystemGuid("12345");
        ...
        try {
        	EasyMock.expect(externalIdService.getAllExternalSystemsOrderedByName()).andReturn(Arrays.asList(externalSystem));
        	//EasyMock.expect(externalIdService.getAllExternalSystemsOrderedByName()).andReturn(Arrays.asList(externalSystem));
			EasyMock.expect(externalIdService.getExternalSystemIdTypesOrderedByName(externalSystem)).andReturn(Arrays.asList(externalSystemIdType));
	...
	@Test
	public void shouldRejectWhenNewSystemIdEmpty() {
		ExternalSystem externalSystem = new ExternalSystem();
		externalSystem.setName("foobar");
		externalSystem.setDescription("description");
		ExternalSystemBean externalSystemBean = new ExternalSystemBean(Arrays.asList(externalSystem));
	...
	@Test
	public void shouldRejectWhenNewSystemIdAlreadyInUse() {
		ExternalSystem externalSystem = new ExternalSystem();
		externalSystem.setName("foobar");
		externalSystem.setDescription("description");
		ExternalSystemBean externalSystemBean = new ExternalSystemBean(Arrays.asList(externalSystem));
...
/*	
	@Test
	public void shouldRejectWhenNewSystemTypeIdIsDuplicateOnlyIfModified() {
		ExternalSystem externalSystem = new ExternalSystem();
		...
		try {
        EasyMock.expect(externalIdService.getAllExternalSystemsOrderedByName()).andReturn(Arrays.asList(externalSystem));
			EasyMock.expect(externalIdService.getExternalSystemIdTypesOrderedByName(externalSystem)).andReturn(new ArrayList<ExternalSystemIdType>(externalSystemIdTypes));
		} catch (ErightsException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	*/
	@Test	
	public void shouldRejectWhenNewSystemTypeIdEmpty() {
		...
		externalSystemBean.getNewExternalSystemIdTypes().get(0).setDescription("a desc");
		externalSystemBean.setSelectedExternalSystemGuid("12345");		
