 ...
 */
@Component
public class ResetPasswordAuth1Test extends AbstractWebServiceAuthenticationTest {

    private Resource request = new ClassPathResource("/soap/v2/resetPasswordRequest1.xml");

    private Resource response = new ClassPathResource("/soap/v2/resetPasswordResponse1.xml");
