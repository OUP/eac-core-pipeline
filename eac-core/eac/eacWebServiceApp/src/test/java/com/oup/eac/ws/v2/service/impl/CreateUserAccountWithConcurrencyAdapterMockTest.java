...
public class CreateUserAccountWithConcurrencyAdapterMockTest extends AbstractMockTest {
	 ...
	 private CustomerService mCustomerService;
	    ...
	    private CreateUserAccountWithConcurrencyAdapterImpl sut;
    ...
    public CreateUserAccountWithConcurrencyAdapterMockTest() throws NamingException {
        super();
    }
    ...
    public void setup() {
        ...
        setMocks(emailService, answerDao, customerDao, registrationDao, extSysDao, licenceService, externalSystemTypeDao, externalIdDao, productService, mMessageSource);
        ...
        this.sut = new CreateUserAccountWithConcurrencyAdapterImpl(mMessageSource, mCustomerService, mCustomerConverter, mExternalIdService,usernameValidator);
    }

    @Test
    public void testNull() {
        CreateUserAccountWithConcurrencyResponse result = sut.createUserAccountsWithConcurrency(null);
    ...
    public void testEmpty() {
        CreateUserWithConcurrency[] empty = {};
        CreateUserAccountWithConcurrencyResponse result = sut.createUserAccountsWithConcurrency(empty);
        Assert.assertNotNull(result);
        Assert.assertEquals(0, result.getUserStatus().length);
    }
    ...
    private void checkSuccess(CreateUserWithConcurrency userData) throws WebServiceValidationException, ServiceLayerException, ErightsException {

        CreateUserWithConcurrency[] users = { userData };

        Customer customer = new Customer();
        /*expect(mCustomerService.getCustomerByUsername("davidhay")).andReturn(null);
        expect(mCustomerConverter.convertCreateUserWithConcurrencyToCustomer(userData)).andReturn(customer);
        ...
        CreateUserAccountWithConcurrencyResponse result = sut.createUserAccountsWithConcurrency(users);
    ...
    public void testManySuccess() throws WebServiceValidationException, ServiceLayerException, ErightsException {
        CreateUserWithConcurrency userA = getCreateUserWithConcurrency("A"+setConstUserName());
        addExternalId(userA, "0198608910"+const_username, "DLP", "ISBN-13");
        CreateUserWithConcurrency userB = getCreateUserWithConcurrency("B"+const_username);
        CreateUserWithConcurrency userC = getCreateUserWithConcurrency("C"+const_username);
        CreateUserWithConcurrency userD = getCreateUserWithConcurrency("D"+const_username);
        CreateUserWithConcurrency[] users = { userA, userB, userC, userD };

        /*for (CreateUserWithConcurrency userData : users) {
            Customer customer = new Customer();
        ...
        EasyMock.expect(this.usernameValidator.isValid("A"+const_username)).andReturn(true);
        EasyMock.expect(this.usernameValidator.isValid("B"+const_username)).andReturn(true);
        EasyMock.expect(this.usernameValidator.isValid("C"+const_username)).andReturn(true);
        EasyMock.expect(this.usernameValidator.isValid("D"+const_username)).andReturn(true);
    ...
    public void testSomeSuccess() throws WebServiceValidationException, ServiceLayerException, ErightsException {
       ...
       /* // A
        ...
        expect(mCustomerConverter.convertCreateUserWithConcurrencyToCustomer(userA)).andReturn(customerA);
        ...
        expect(mCustomerConverter.convertCreateUserWithConcurrencyToCustomer(userC)).andReturn(customerC);
...
*/
    ...
    private CreateUserWithConcurrency getCreateUserWithConcurrency(String username) {
        CreateUserWithConcurrency result = getCreateUserWithConcurrency();
        result.getCredentials().getPasswordCredential().setUserName(username);
        return result;
    }
    
    private CreateUserWithConcurrency addExternalId(CreateUserWithConcurrency createUserWithConcurrency, String id, String systemId, String typeId) {
        ExternalIdentifier externalIdentifier = new ExternalIdentifier();
        externalIdentifier.setId(id);
        externalIdentifier.setSystemId(systemId);
        externalIdentifier.setTypeId(typeId);
        createUserWithConcurrency.addExternal(externalIdentifier);
        return createUserWithConcurrency;
    }
    ...
    public void testAlreadyExists() throws WebServiceValidationException, ServiceLayerException, ErightsException {
        ...
        CreateUserAccountWithConcurrencyResponse result = sut.createUserAccountsWithConcurrency(users);
        result = sut.createUserAccountsWithConcurrency(users);
    ...
    private CreateUserWithConcurrency getCreateUserWithConcurrency() {
        ...
        // USER CONCURRENCY
        user.setUserConcurrency(100);

        return user;
    }
    
    private void checkInvalid(CreateUserWithConcurrency user, String expectedErrorMessage) throws ErightsException {
        checkInvalid(user,expectedErrorMessage,true);
    }

    private void checkInvalid(CreateUserWithConcurrency user, String expectedErrorMessage, boolean checkCustomerExists) throws ErightsException {
        CreateUserWithConcurrency[] users = { user };
    ...
    private void checkClientError(CreateUserWithConcurrency user, CreateUserAccountWithConcurrencyResponse result, String expectedErrorMessage) {
        Assert.assertNotNull(result);
        Assert.assertEquals(1, result.getUserStatus().length);
        UserStatusType us1 = result.getUserStatus(0);
    ...
    private String getUserName(CreateUserWithConcurrency user) {
   ...
   /* @Test
    public void testServiceLayerValidationException() throws ServiceLayerException, ErightsException {
        ...
        CreateUserWithConcurrency user2 = getCreateUserWithConcurrency(user1.getCredentials().getPasswordCredential().getUserName());
        CreateUserWithConcurrency[] users = { user1, user2 };
        ...
        expect(mCustomerConverter.convertCreateUserWithConcurrencyToCustomer(user1)).andReturn(customer1);
        expect(mCustomerConverter.convertCreateUserWithConcurrencyToCustomer(user2)).andReturn(customer2);
        ...
        replay(getMocks());
        CreateUserAccountWithConcurrencyResponse result = this.sut.createUserAccountsWithConcurrency(users);
        //verify(getMocks());
        ...
        Assert.assertEquals("SUCCESS",status1.getErrorStatus().getStatusCode().toString());
    ...
    @Test
    public void testValidBlankUserConcurrency() throws WebServiceValidationException, ServiceLayerException, ErightsException {
    ...
    @Test
    public void testInvalidUserConcurrency() throws WebServiceValidationException, ServiceLayerException, ErightsException {
        CreateUserWithConcurrency user = getCreateUserWithConcurrency();
    ...
    @Test
    public void testValidZeroUserConcurrency() throws WebServiceValidationException, ServiceLayerException, ErightsException {
        
        CreateUserWithConcurrency user = getCreateUserWithConcurrency();
        user.setUserConcurrency(0);
        checkSuccess(user);
    }
