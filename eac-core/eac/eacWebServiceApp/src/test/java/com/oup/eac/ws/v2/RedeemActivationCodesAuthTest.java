 ...
 */
@Component
public class RedeemActivationCodesAuthTest extends AbstractWebServiceAuthenticationTest {

    private Resource request = new ClassPathResource("/soap/v2/redeemActivationCodesRequest1.xml");

    private Resource response = new ClassPathResource("/soap/v2/redeemActivationCodesResponse1.xml");
