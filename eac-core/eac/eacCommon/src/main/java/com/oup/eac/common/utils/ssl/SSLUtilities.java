...
public final class SSLUtilities {
    ...
    /**
     * Set the default Hostname Verifier to an instance of a fake class that trust all hostnames. This method uses the old deprecated API from the com.sun.ssl
     * package.
     * 
    ...
    /**
     * Set the default X509 Trust Manager to an instance of a fake class that trust all certificates, even the self-signed ones. This method uses the old
    ...
    /**
     * Return true if the protocol handler property java. protocol.handler.pkgs is set to the Sun's com.sun.net.ssl. internal.www.protocol deprecated one, false
     * otherwise.
     * 
    ...
    /**
     * This class allow any X509 certificates to be used to authenticate the remote side of a secure socket, including self-signed certificates. This class uses
