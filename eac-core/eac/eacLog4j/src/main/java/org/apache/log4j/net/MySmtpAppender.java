 ...
 * @since 1.0
 */
public class MySmtpAppender extends AppenderSkeleton {
    
    private static final Logger LOG = Logger.getLogger(MySmtpAppender.class);
     ...
     */
    public MySmtpAppender(TriggeringEventEvaluator evaluator) {
    ...
    */
    ...
    public void setEvaluatorClass(String value) {
        ...
        LOG.debug("evaluator is " + evaluator);
    }
