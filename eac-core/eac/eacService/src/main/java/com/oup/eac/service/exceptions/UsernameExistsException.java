...
public class UsernameExistsException extends ServiceLayerException {
     ...
     *            the messages
     */
    public UsernameExistsException(final String message, final Message... messages) {
     ...
     *            the nested messages
     */
    public UsernameExistsException(final String message, final Throwable cause, final Message... messages) {
