...
public class LicenceDeniedVelocityTest {
	 ...
	 * ClassPathResource("com/oup/eac/service/impl/licenceDeniedExpected.txt");
	 * 
	 ...
	 * ve.getTemplate("com/oup/eac/service/velocity/licenceDenied.vm");
	 ...
	 * ctx.put("productname", "ProductXYZ"); ctx.put("validatoremail",
