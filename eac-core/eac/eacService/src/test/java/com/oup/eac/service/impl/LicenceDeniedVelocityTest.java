...
public class LicenceDeniedVelocityTest {
    ...
    private Resource expected = new ClassPathResource("com/oup/eac/service/impl/licenceDeniedExpected.txt");

    private MessageTextSource resource = null;

    public LicenceDeniedVelocityTest() throws NamingException {
    ...
    public void testValidatedRegistrationTemplate() throws Exception {
        ...
        Template t = ve.getTemplate("com/oup/eac/service/velocity/licenceDenied.vm");
        ...
        ctx.put("validatoremail", "admin@mailinator.com");
