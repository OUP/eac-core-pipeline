...
public class AccountsLoginFormValidatorTest extends AbstractValidatorTest{

    private AccountsLoginFormValidator validator;

    public AccountsLoginFormValidatorTest() throws NamingException {
        super();
    }
    ...
    public void setUp() {
        super.setUp();
        validator = new AccountsLoginFormValidator();
    }
