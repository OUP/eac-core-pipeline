...
public class AccountsRegistrationFormValidatorTest extends AbstractValidatorTest {
    ...
    private AccountsRegistrationFormValidator validator;
    ...
    public void setUp() {
        ...
        validator = new AccountsRegistrationFormValidator(customerService, usernameValidator);
    }
    
    @Test
    public void testValidateNoFirstNameValues() throws Exception {
    ...
    @Test
    public void testValidateNoFamilyNameValues() throws Exception {
        AccountRegistrationDto accountRegistrationDto = new AccountRegistrationDto();
    ...
    @Test
    public void testValidateNoUsernameValues() throws Exception {
        AccountRegistrationDto accountRegistrationDto = new AccountRegistrationDto();
    ...
    @Test
    public void testValidateNoEmailValues() throws Exception {
        AccountRegistrationDto accountRegistrationDto = new AccountRegistrationDto();

        accountRegistrationDto.setFirstName("firstName");
        accountRegistrationDto.setFamilyName("familyName");
        accountRegistrationDto.setUsername("jsmith.test@test.com");
        EasyMock.expect(usernameValidator.isValid("jsmith.test@test.com")).andReturn(true);
        EasyMock.expect(customerService.getCustomerByUsername("jsmith.test@test.com")).andReturn(null);
    ...
    public void testValidateOnlyUsernameCustomerAlreadyExists() throws Exception {
        ...
        errors.rejectValue(EasyMock.eq("username"), EasyMock.eq("error.username.taken.update"),
