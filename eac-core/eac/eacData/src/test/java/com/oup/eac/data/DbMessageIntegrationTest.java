...
public class DbMessageIntegrationTest extends AbstractDbMessageTest {
    ...
    public final void setUp() throws Exception {
        ...
        Message message1 = this.createDbMessage("messages",messageCode, messageText);
        
        int before = countRowsInTable("message");
        loadAllDataSets();
        int after = countRowsInTable("message");
    ...
    public void testMessageSource(){
        String actual = this.messageSource.getMessage(messageCode, new Object[0], this.locale);
