...
import com.oup.eac.data.OUPBaseDao;
 ...
 *            the ID
 */
public abstract class OUPHibernateBaseDao<T extends OUPBaseDomainObject, ID extends Serializable>  implements OUPBaseDao<T, ID> {
    ...
    public OUPHibernateBaseDao(final SessionFactory sf) {
        this.sessionFactory = sf;
        Class clazz = getClass();
        while (!(clazz.getGenericSuperclass() instanceof ParameterizedType)) {
            clazz = clazz.getSuperclass();
        }
        List<Class<?>> types = getTypeArguments(OUPHibernateBaseDao.class, this.getClass());                               
