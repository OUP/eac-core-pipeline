...
<form action="test" id="frmvalidateAllowed"> 
		...
		<div class="row">
			<div class="col large-8 large-centered">
						...
						<div class="message message--success">
							<h4><spring:message code="title.validatorlicenceallowed"	text="?title.validatorlicenceallowed?" />
							</h4>
							<p>
									<spring:message code="label.validatorlicenceallowed" text="?label.validatorlicenceallowed?" />
