...
<c:url value="/mvc/uploadProducts/upload.htm" var="formUrl"/>
<div>
	<div id="heading" class="ui-corner-top">
	   <h1><spring:message code="title.uploadProducts" /></h1>
	</div>
	...
	<div id="help">
	Product file must follow below requirements:
	<ul>
    ...
    <fieldset>
        <legend><spring:message code="label.upload.product.file"/></legend>
