	...
	<div id="advanced-${licenceId}" style="clear: both; padding-top:10px;">
		...
		<div>
			<div class="field">
				...
				<div class="fieldValue">
					<form:checkbox id="licenceEnabled-${licenceId}" path="${licencePath}.enabled" cssClass="checkbox"/>
				</div>
			</div>
			<div class="field">
				<div class="fieldLabel">
				...
				<div class="fieldValue">
					<form:input id="licenceStartDate-${licenceId}" path="${licencePath}.startDate" />
			...
			<div class="field">
				...
				<div class="fieldValue">
					<form:input id="licenceEndDate-${licenceId}" path="${licencePath}.endDate" />
	              	<script type="text/javascript">
			...
			<c:choose>
				<c:when test="${licence.licenceDetail.licenceType eq 'CONCURRENT'}">
					<div class="field">
						...
						<div class="fieldValue">
							<form:input id="licenceTotalConcurrency-${licenceId}" path="${licencePath}.licenceDetail.totalConcurrency" />
						</div>
					</div>
				    <div class="field">
						<div class="fieldLabel">
						...
						<div class="fieldValue">
							<form:input id="licenceUserConcurrency-${licenceId}" path="${licencePath}.licenceDetail.userConcurrency" />
						</div>
					</div>
				</c:when>
				<c:when test="${licence.licenceDetail.licenceType eq 'ROLLING'}">
					<div class="field">
						...
						<div class="fieldValue">
							<form:input id="licenceTimePeriod-${licenceId}" path="${licencePath}.licenceDetail.timePeriod" />
						</div>
					</div>
					<div class="field">
						<div class="fieldLabel">
						...
						<div class="fieldValue">
							<form:select id="licenceRollingUnitType-${licenceId}" path="${licencePath}.licenceDetail.unitType" >
					...
					<div class="field">
						...
						<div class="fieldValue">
							<form:select id="licenceRollingBeginOn-${licenceId}" path="${licencePath}.licenceDetail.beginOn" >
				...
				<c:when test="${licence.licenceDetail.licenceType eq 'USAGE'}">
					<div class="field">
						...
						<div class="fieldValue">
							<form:input id="licenceAllowedUsages-${licenceId}" path="${licencePath}.licenceDetail.allowedUsages" />
						</div>
					</div>
					<div class="field">
                        <div class="fieldLabel">
