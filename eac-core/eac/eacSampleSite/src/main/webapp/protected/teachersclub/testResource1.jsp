...
<html>
    <head>
        <title>EAC Teachers Club Test Resource</title>
    ...
    <body onload="init('<%=EACSettings.getProperty("cookie.host")%>')" style="background:<%=EACSettings.getProperty("deploy.bgcolor")%>">
        <div id="page" class="container">
            ...
            <div id="left" class="span-4">
                <img src="<c:url value="/images/success-addmath.jpg" />" width="79" height="106" alt="Test Resource 1" />
            </div>
            <div id="main" class="span-14">             
                <b>Teachers Club Test Resource 1<br/>                
                </b>
            </div>
        </div>
    </body>
