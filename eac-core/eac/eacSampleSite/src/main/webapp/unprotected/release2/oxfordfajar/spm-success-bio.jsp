...
<html>
	...
	<body onload="init(<%=EACSettings.getProperty("cookie.host")%>)">
		<div id="page" class="container">
			...
			<div id="left" class="span-4">
				<img src="<c:url value="/images/success-bio.jpg" />" width="79" height="106" alt="Additional Math" />
			</div>
			<div id="main" class="span-14">				
				<b>Biology Product - Landing Page (Not Protected Content)<br/>
				(Principals of Management, HE Student Content 1)</b>
			</div>
		</div>
	</body>
</html>