...
<html>
<head>
<title>Basic Test Page for Eac Login Widget 1/2</title>

<%@ include file="/WEB-INF/jsp/include.jsp" %>

<c:set var="dir" value="/eacSampleSite/unprotected/release2/teachersclub" />
<c:set var="locale" value="en_GB" />
<c:set var="successUrl" value="${urlPrefix}${dir}/loginWidgetTestBasic.jsp" />
...
<body>
<div>
<form method="post" action="loginWidgetTestBasic.jsp">
