...
/**
 * @author harlandd MailCriteria class to hold all relevent email information.
 */
public class MailCriteria {
	...
	public String toString() {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat(EACSettings.getProperty(EACSettings.EMAIL_SENT_DEBUG_FORMAT));
